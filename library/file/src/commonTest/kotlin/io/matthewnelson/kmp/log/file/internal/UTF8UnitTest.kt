...
import io.matthewnelson.kmp.log.file.internal.UTF8.utf8Size
...
class UTF8UnitTest {
    ...
    fun givenRandomSequences_whenEncoded_thenMatchesKotlinEncoding() {
        ...
        repeat(times) { i ->
            ...
            assertEquals(expected.size, text.utf8Size().toInt(), "sizes >> run[$i]")
    ...
    private fun assertUtf8(hex: String) {
        ...
        assertEquals(expected.size, kotlinUtf8.utf8Size().toInt())
