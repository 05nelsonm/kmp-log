...
fun main() {
    ...
    // granular insight into the library's inner workings, if and only
...
<!-- TAG_VERSION -->
[badge-latest]: https://img.shields.io/badge/latest--release-0.1.2-blue.svg?style=flat
...
[badge-kmp-file]: https://img.shields.io/badge/kmp--file-0.6.1--SNAPSHOT-blue.svg?style=flat
